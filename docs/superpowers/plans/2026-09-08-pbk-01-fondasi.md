...
| `src/proxy.ts` | Proteksi seluruh route `(app)` |
...
**Files:**
- Create: `src/proxy.ts`, `src/lib/actions/logout.ts`
...
`src/proxy.ts` — memakai `authConfig` yang bebas-Prisma agar aman di Edge:
