          ...
          {activity ? (
            <>
              ...
              <p className="mt-4 text-[12.5px] text-gray-500">
                ...
                <Link href="/master/kegiatan" className="font-semibold text-brand-700">Master Data › Daftar Kegiatan</Link>. Nomor yang sudah terpakai tidak pernah dipakai ulang.
              </p>
            </>
          ) : (
