...
export const ROUTES: Record<string, RouteMeta> = {
  ...
  '/master/kelas': { title: 'Data Kelas', subtitle: 'Master kelas dan wali kelas per tingkat', crumbs: ['Master Data', 'Data Kelas'] },
  '/master/kegiatan': { title: 'Daftar Kegiatan', subtitle: 'Seluruh kegiatan sekolah yang dikelola KASERA', crumbs: ['Master Data', 'Daftar Kegiatan'] },
